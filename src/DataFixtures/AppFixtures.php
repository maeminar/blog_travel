...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        for ($i = 0; $i < self::NB_ARTICLES; $i++) {
            ...
            // Ajouter une référence pour chaque article
        ...
        for ($i = 0; $i < 50; $i++) {
            ...
            // Associer le commentaire à un article aléatoire
            $comment->setArticles($this->getReference('article_' . $faker->numberBetween(0, self::NB_ARTICLES - 1)));
